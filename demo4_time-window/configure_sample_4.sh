...
display_sample_info() {
    ...
    echo "|    according to the abnormal or suspecious user behaviour.         |" 
    echo "|                                                                    |"
    echo "|    For this demo, other than WSO2 IS, WSO2 Stream Processor        |"
    echo "|    is used.                                                        |"
    echo "|                                                                    |"
    echo "|    Story:                                                          |"
    ...
    echo "|    password.                                                       |"
    echo "|                                                                    |"
    echo "|    2. Alex makes multiple orders under the “Single Ride” and cancel|"
    echo "|    them ( 3 bookings and 3 cancellation within 1 min).             |"
    echo "|                                                                    |"
    echo "|                                                                    |"
    echo "|    4. When Alex try to book a taxi for the 4th time, he is         |"
    echo "|    promoted for OTP verification                                   |"
    echo "|                                                                    |"
...
echo "PREREQUISITES                                                   "
echo
echo "This sample requires WSO2 stream processor. Please download the latest release of Stream processor from "
echo "https://github.com/wso2/product-sp/releases"
echo
echo "and unzip to a local file location. We will call the unzipped directory as <WSO2SP_HOME>"
echo
